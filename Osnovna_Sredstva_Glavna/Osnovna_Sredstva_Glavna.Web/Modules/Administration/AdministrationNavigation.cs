...
using Administration = Osnovna_Sredstva_Glavna.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: Osnovna_Sredstva_Glavna.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
