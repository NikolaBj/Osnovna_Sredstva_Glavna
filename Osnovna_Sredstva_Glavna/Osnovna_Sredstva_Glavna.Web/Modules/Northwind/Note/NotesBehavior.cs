using Osnovna_Sredstva_Glavna.Administration.Entities;
using Osnovna_Sredstva_Glavna.Northwind.Entities;
using Osnovna_Sredstva_Glavna.Northwind.Repositories;
using Serenity;
using Serenity.Data;
