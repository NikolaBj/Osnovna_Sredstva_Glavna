...
namespace Osnovna_Sredstva_Glavna.OsnovnaSredstva.Entities
{
    ...
    [DisplayName("Osnovno Id"), Identity]
        ...
        [DisplayName("Amortizirana Vrijednost"), Column("Amortizirana_vrijednost"), Size(11), Scale(2), DisplayFormat("#,##0.00"), AlignRight]
        ...
        [DisplayName("Knjigovodstvena Vrijednost"), Column("Knjigovodstvena_vrijednost"), Size(11), Scale(2), DisplayFormat("#,##0.00") , AlignRight]
        ...
        [DisplayName("Umanjenje Vrijednosti"), Column("Umanjenje_vrijednosti"), Size(11), Scale(2), DisplayFormat("#,##0.00"), AlignRight]
        ...
        [DisplayName("Sektor"), NotNull, ForeignKey("[dbo].[Sektori]", "SektorId"), LeftJoin("jSektor"), TextualField("SektorNaziv"), LookupEditor(typeof(Osnovna_Sredstva.Default.Lookups.SektorLookup), AutoComplete = true)]
        ...
        [DisplayName("Am Grupa"), NotNull, ForeignKey("[dbo].[Amortizacijske_grupe]", "AmGrupaId"), LeftJoin("jAmGrupa"), TextualField("AmGrupaNaziv"),LookupEditor(typeof(Osnovna_Sredstva.Default.Lookups.NameUserLookup), AutoComplete = true)]
        ...
        [DisplayName("Konto"), NotNull, ForeignKey("[dbo].[Konta]", "KontoId"), LeftJoin("jKonto"), TextualField("KontoNaziv"), LookupEditor(typeof(Osnovna_Sredstva.Default.Lookups.KontaLookup), AutoComplete = true)]
        ...
        [DisplayName("Napomena"),TextAreaEditor, Size(200)]
        ...
        [DisplayName("Stopa Am Sredstva"), Column("Stopa_am_sredstva"), Size(5), Scale(2), LookupEditor(typeof(Osnovna_Sredstva.Default.Lookups.GodAmortizacijaLookup), CascadeFrom = "AmGrupaId", AutoComplete = true)]
        ...
        [DisplayName("Ura broj"), Expression("jUra.[UraBroj]")]
