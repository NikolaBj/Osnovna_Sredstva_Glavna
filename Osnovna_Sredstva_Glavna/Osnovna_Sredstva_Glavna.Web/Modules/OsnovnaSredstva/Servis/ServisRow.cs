...
namespace Osnovna_Sredstva_Glavna.OsnovnaSredstva.Entities
{
    ...
    public sealed class ServisRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Osnovno"), NotNull, ForeignKey("[dbo].[Osnovno_Sredstvo]", "OsnovnoId"), LeftJoin("jOsnovno"), TextualField("OsnovnoNazivOpreme"), LookupEditor(typeof(Osnovna_Sredstva.Default.Lookups.OsnovnoLookup), AutoComplete = true)]
        ...
        [DisplayName("Active"),DefaultValue(true), Hidden]
        ...
        [DisplayName("Date Time Created"),  DefaultValue("now"), Hidden]
        ...
        [DisplayName("Iznos Servisa"), Size(11), Scale(2), DisplayFormat("#,##0.00")]
        ...
        [DisplayName("Vrsta Troska"), Column("VrstaTroskaID"), ForeignKey("[dbo].[Vrsta_troska]", "VrstaTroskaID"), LeftJoin("jVrstaTroska"), TextualField("VrstaTroskaNaziv"), LookupEditor(typeof(Osnovna_Sredstva.Default.Lookups.VrstaTroska), AutoComplete = true)]
        ...
        //[DisplayName("Dokument"), ForeignKey("[dbo].[Dokumentacija]", "DokumentId"), LeftJoin("jDokument"), TextualField("DokumentNaziv")]
        ...
        //[DisplayName("Dokument Naziv"), Expression("jDokument.[Naziv]")]
        //public String DokumentNaziv
        //{
        //    get { return Fields.DokumentNaziv[this]; }
        //    set { Fields.DokumentNaziv[this] = value; }
        //}

        //[DisplayName("Dokument Active"), Expression("jDokument.[Active]")]
        //public Boolean? DokumentActive
        //{
        //    get { return Fields.DokumentActive[this]; }
        //    set { Fields.DokumentActive[this] = value; }
        //}

        //[DisplayName("Dokument File Content"), Expression("jDokument.[FileContent]")]
        //public String DokumentFileContent
        //{
        //    get { return Fields.DokumentFileContent[this]; }
        //    set { Fields.DokumentFileContent[this] = value; }
        //}

        //[DisplayName("Dokument Date Time Created"), Expression("jDokument.[DateTimeCreated]")]
        //public DateTime? DokumentDateTimeCreated
        //{
        //    get { return Fields.DokumentDateTimeCreated[this]; }
        //    set { Fields.DokumentDateTimeCreated[this] = value; }
        //}

        //[DisplayName("Dokument Osnovno Id"), Expression("jDokument.[OsnovnoId]")]
        //public Int32? DokumentOsnovnoId
        //{
        //    get { return Fields.DokumentOsnovnoId[this]; }
        //    set { Fields.DokumentOsnovnoId[this] = value; }
        //}

        //[DisplayName("Dokument Servis Id"), Expression("jDokument.[ServisId]")]
        //public Int32? DokumentServisId
        //{
        //    get { return Fields.DokumentServisId[this]; }
        //    set { Fields.DokumentServisId[this] = value; }
 //       }
        ...
        [DisplayName("Dokumentacija"), MasterDetailRelation(foreignKey: "ServisId")]
        public List<DokumentacijaRow> DetailList
        {
        ...
        public class RowFields : RowFieldsBase
        {
           ...
           // public Int32Field DokumentId;
            ...
            //public StringField DokumentNaziv;
            //public BooleanField DokumentActive;
            //public StringField DokumentFileContent;
            //public DateTimeField DokumentDateTimeCreated;
            //public Int32Field DokumentOsnovnoId;
            //public Int32Field DokumentServisId;
            public RowListField<DokumentacijaRow> DetailList;
        }
    }
}
